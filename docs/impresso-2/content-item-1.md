## ContentItem Core Fields (part of composed schema) Type

`object` ([ContentItem Core Fields (part of composed schema)](content-item-1.md))

# ContentItem Core Fields (part of composed schema) Properties
