...
| :-------- | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [tc](#tc) | `array`   | Optional | cannot be null | [Audio Record Content Item](audio-record-contentitem-properties-rreb-items-properties-t-items-properties-tc.md "https://impresso.github.io/impresso-schemas/json/impresso-2/data-preparation/rebuilt/audio-record-contentitem.v1.schema.json#/properties/rreb/items/properties/t/items/properties/tc") |
...
* defined in: [Audio Record Content Item](audio-record-contentitem-properties-rreb-items-properties-t-items-properties-tc.md "https://impresso.github.io/impresso-schemas/json/impresso-2/data-preparation/rebuilt/audio-record-contentitem.v1.schema.json#/properties/rreb/items/properties/t/items/properties/tc")
