## Audio Content Item (Composed Schema) Type

`object` ([Audio Content Item (Composed Schema)](content-item-9.md))

all of

* [ContentItem Core Fields (part of composed schema)](sem-6-allof-contentitem-core-fields-part-of-composed-schema.md "check type definition")

* [ContextualMetadataFields](sem-6-allof-contextualmetadatafields.md "check type definition")

* [Provider Contextual Metadata Fields](content-item-9-allof-provider-contextual-metadata-fields.md "check type definition")

* [AccessRightFields](sem-6-allof-accessrightfields.md "check type definition")
...
* [Semantic Enrichments Fields (part of composed schema)](sem-6-allof-semantic-enrichments-fields-part-of-composed-schema.md "check type definition")

* [Content Item - Audio Part Schema](content-item-9-allof-content-item---audio-part-schema.md "check type definition")
