## Impresso content-item identifier Type

`string` ([Impresso content-item identifier](content-item-id.md))

## Impresso content-item identifier Constraints
...
## Impresso content-item identifier Examples
