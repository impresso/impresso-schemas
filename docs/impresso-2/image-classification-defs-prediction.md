...
`object` ([Details](image-classification-defs-prediction.md))

all of

* [Untitled undefined type in Image Classification](image-classification-defs-prediction-allof-0.md "check type definition")

* [Untitled undefined type in Image Classification](image-classification-defs-prediction-allof-1.md "check type definition")

* [Untitled undefined type in Image Classification](image-classification-defs-prediction-allof-2.md "check type definition")
