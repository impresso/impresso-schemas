...
IMPRESSO_2_CASES = [
    ...
    ("json/impresso-2/semantic-enrichment/entities/entities-ner.v1.schema.json", "examples/impresso-2/semantic-enrichment/entities/entities-ner.example1.json"),
    ("json/impresso-2/semantic-enrichment/entities/entities-ner.v1.schema.json", "examples/impresso-2/semantic-enrichment/entities/entities-ner.example2.json"),
